        ...
        <div className="col-md-6 left">
          <div className="inner">
            ...
            <div className="cnt-block">
              <h1>APPLICATION FOR CERTIFICATE COURSE</h1>
              <p>
              The form APPLICATION FOR CERTIFICATE COURSE is no longer accepting responses.Try contacting the owner of the form if you think that this is a mistake.
              </p>
            </div>
